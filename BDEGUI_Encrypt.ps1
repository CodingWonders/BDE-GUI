...
$ResumeEncryption_Button_Click = {
	if ((Resume-VolumeEncryption -DeviceID "$($global:volumes[$VolumesComboBox.SelectedIndex].DeviceID)") -eq $S_OK) {
...
$PauseEncryption_Button_Click = {
	if ((Pause-VolumeEncryption -DeviceID "$($global:volumes[$VolumesComboBox.SelectedIndex].DeviceID)") -eq $S_OK) {
